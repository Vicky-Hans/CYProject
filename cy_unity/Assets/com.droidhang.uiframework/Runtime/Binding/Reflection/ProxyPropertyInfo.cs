...
namespace DH.UIFramework.Reflection
{
    ...
    public class ProxyPropertyInfo<T, TValue> : ProxyPropertyInfo, IProxyPropertyInfo<T, TValue>
    {
        ...
        public override Type ValueType { get { return valueType == null ? base.ValueType : valueType; } }
        ...
        public ProxyPropertyInfo(PropertyInfo propertyInfo, string propertyName, Func<T, TValue> getter,
            Action<T, TValue> setter) : this(propertyInfo,getter,setter)
        {
        ...
        {
            if (propertyInfo != null && (!typeof(TValue).Equals(this.propertyInfo.PropertyType) || !propertyInfo.DeclaringType.IsAssignableFrom(typeof(T))))
                throw new ArgumentException("The property types do not match!");
        ...
        public override string Name => string.IsNullOrEmpty(propertyName) ? base.Name : propertyName;
