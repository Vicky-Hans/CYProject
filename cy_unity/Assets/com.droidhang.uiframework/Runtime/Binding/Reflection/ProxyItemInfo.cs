...
namespace DH.UIFramework.Reflection
{
    public class ProxyItemInfo : IProxyItemInfo
    {
        ...
        public ProxyItemInfo(Type declaringType,Type valueType)
        {
            this.declaringType = declaringType;
            this.valueType = valueType;
            isValueType = this.valueType.IsValueType;
        }
    ...
    {
        public ListProxyItemInfo(Type declaringType,Type valueType) : base(declaringType,valueType)
        {
        }
    ...
    {
        public DictionaryProxyItemInfo(Type declaringType,Type valueType) : base(declaringType,valueType)
        {
