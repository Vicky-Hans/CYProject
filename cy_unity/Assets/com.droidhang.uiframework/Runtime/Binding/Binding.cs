    ...
    public class Binding : AbstractBinding
    {
        ...
        protected BindingMode BindingMode
        {
            get
            {
                ...
                if (bindingMode == BindingMode.Default) 
                    DHLog.Error("Not set the BindingMode!");
        ...
        protected void UpdateDataOnBind()
        {
            ...
            {
                DHLog.Error("An exception occurs in UpdateTargetOnBind.exception: {0}", e);
            }
        }
        ...
        protected void DoUpdateTargetFromSource(object state)
        {
            ...
            {
                DHLog.Error("An exception occurs when the target property is updated.Please check the binding \"{0}{1}\" in the view \"{2}\".exception: {3}", this.targetTypeName, this.bindingDescription.ToString(), GetViewName(), e);
            }
            finally
            {
        ...
        protected virtual void UpdateSourceFromTarget()
        {
            ...
            {
                DHLog.Error("An exception occurs when the source property is updated.Please check the binding \"{0}{1}\" in the view \"{2}\".exception: {3}", this.targetTypeName, this.bindingDescription.ToString(), GetViewName(), e);
            }
            finally
            {
        ...
        protected virtual void UpdateSourceWithDefaultValue()
        {
            try
            {
                if (this.isUpdatingTarget)
                ...
                switch (typeCode)
                {
                    case TypeCode.Object:
                        {
                            var value = obtainable.GetValue();
                            this.SetSourceValue(modifier, (object)null);
                            break;
                        }
                    default:
                        {
        ...
        protected void SetTargetValue<T>(IModifiable modifier, T value)
        {
            ...
            {
                this.converter.Convert(value,modifier);
                return;
            }
