...
{
    public class BindingContext : IBindingContext, IUnityLifeCycle
    {
        ...
        public object DataContext
        {
            ...
            set
            {
                ...
                this.vmBase = value as ViewModelBase;
            }
        }
        ...
        protected void RaiseDataContextChanged()
        {
            ...
            {
                DHLog.Error(e.ToString());
            }
        }

        public void PauseBind(bool flag)
        {
            if (flag)
            {
