...
namespace DH.UIFramework.Proxy.Sources.Object
{
    ...
    public class LongItemNodeProxy : ItemNodeProxy<long>
    {
        public LongItemNodeProxy(ICollection source, long key, IProxyItemInfo itemInfo) : base(source, key, itemInfo)
        {
        }
        ...
        public override TValue GetValue<TValue>()
        {
            ...
            var proxy = itemInfo as IProxyItemInfo<long, TValue>;
            if (proxy != null)
                return proxy.GetValue(source, key);
