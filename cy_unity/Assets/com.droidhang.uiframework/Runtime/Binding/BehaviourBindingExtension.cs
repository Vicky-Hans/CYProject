...
namespace DH.UIFramework
{
    public static class BehaviourBindingExtension
    {
        ...
        public static BindingSet<TBehaviour, TSource> CreateBindingSet<TBehaviour, TSource>(this TBehaviour behaviour) where TBehaviour : Behaviour
        {
            ...
            var bindingSet = new BindingSet<TBehaviour, TSource>(context, behaviour);
            bindingSet.baseView = behaviour as BaseView;
            if (bindingSet.baseView)
            {
                bindingSet.baseView.bindingSetBase = bindingSet;
            }
            return bindingSet;
        }
