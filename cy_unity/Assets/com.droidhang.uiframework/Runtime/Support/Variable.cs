...
namespace DH.UIFramework
{
    ...
    public class Variable
    {
        ...
        [SerializeField] protected string dataValue;
        ...
        public static Variable Create<T>(string name, T value)
        {
            var variable = new Variable()
            {
                variableType = value?.GetType() == typeof(GameObject) ? VariableType.GameObject : VariableType.Component,
                name = name
            };
