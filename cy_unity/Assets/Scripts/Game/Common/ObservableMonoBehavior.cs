...
namespace DH.Game
{
    public class ObservableMonoBehavior : MonoBehaviour, INotifyPropertyChanged
    {
        ...
        protected virtual void RaisePropertyChanged(PropertyChangedEventArgs eventArgs)
        {
            ...
            {
                DHLog.Error("Set property '{0}', raise PropertyChanged failure.Exception:{1}", eventArgs.PropertyName,
                    e);
            }
        }
        ...
        protected virtual void RaisePropertyChanged(params PropertyChangedEventArgs[] eventArgs)
        {
            foreach (var args in eventArgs)
            {
                ...
                {
                    DHLog.Error("Set property '{0}', raise PropertyChanged failure.Exception:{1}", args.PropertyName,
                        e);
                }
            }
        }
