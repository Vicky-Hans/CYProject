...
namespace DH.Game
{
    public partial class PlayerSkill1200 : BaseSkill
    {
        ...
        public override void Shoot(WeaponSkill weaponSkill)
        {
            ...
            var bulletComp = bullet.GetComponent<PlayerBullet1200>();
        ...
        private string GetBulletPath(int weaponModelId)
        {
            ...
            {
                case 1201: return bulletPath1;
                case 1202: return bulletPath2;
                case 1203: return bulletPath3;
                case 1204: return bulletPath4;
                case 1205: return bulletPath5;
                case 1206: return bulletPath6;
            }
            return bulletPath1;
        }
