...
namespace DH.Game
{
    public partial class PlayerSkill2200 : BaseSkill
    {
        ...
        public override async void Shoot(WeaponSkill weaponSkill)
        {
            ...
            var bulletComp = bullet.GetComponent<PlayerBullet2200>();
        ...
        public string GetBulletPath(int weaponModelId)
        {
            ...
            {
                case 2201: return bulletPath1;
                case 2202: return bulletPath2;
                case 2203: return bulletPath3;
                case 2204: return bulletPath4;
                case 2205: return bulletPath5;
                case 2206: return bulletPath6;
            }
            return bulletPath1;
        }
