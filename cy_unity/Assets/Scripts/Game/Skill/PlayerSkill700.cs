...
namespace DH.Game
{
    public partial class PlayerSkill700 : BaseSkill
    {
        ...
        public override void Shoot(WeaponSkill weaponSkill)
        {
            ...
            var bulletComp = bullet.GetComponent<PlayerBullet700>();
        ...
        private string GetBulletPath(int weaponModelId)
        {
            ...
            {
                case 701: return bulletPath1;
                case 702: return bulletPath2;
                case 703: return bulletPath3;
                case 704: return bulletPath4;
                case 705: return bulletPath5;
                case 706: return bulletPath6;
            }
            return bulletPath1;
        }
