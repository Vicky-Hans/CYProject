...
{
    public partial class LuckEggDrawTopProgressView : BaseItemView
    {
        ...
        {
	        await base.Create();
	        var bindSet = this.CreateBindingSet<LuckEggDrawTopProgressView, LuckEggDrawTopProgressViewModel>();
