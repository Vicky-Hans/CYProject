...
{
    public partial class CommonSkillTipsView : BaseView
    {
        ...
        {
            await base.Create();
            var bindSet = this.CreateBindingSet<CommonSkillTipsView, CommonSkillTipsModel>();
        ...
        public Vector3 CalcPos(Vector3 position, Vector3 offset, bool IsOpenOffset)
        {
            ...
            // var bgPos = bgRectTransform.transform.localPosition;
            // bgPos.x = offset.x;
            // bgRectTransform.transform.localPosition = bgPos;
