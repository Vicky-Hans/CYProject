...
namespace DH.Config 
{
	...
	[DHDataTableObject]
	[MessagePackObject]
	public partial class MainGrinding150Cfg
	{
		[Key(0)]
		...
		public MainGrinding150Cfg()
		{
		}

		[SerializationConstructor]
		public MainGrinding150Cfg(int Id, int NextId, int CustomId, int NowWave, int Time, int GringTime, int Incident, int HpCoefficient, int AtkCoefficient, List<Grinding> Summon)
		{
			this.Id = Id;
			this.NextId = NextId;
	...
	public partial class MainGrinding150CfgCollection : CfgCollectionBase<MainGrinding150Cfg>
	{
		private const string dataPath = "MainGrinding150";
		private Dictionary<int, MainGrinding150Cfg> idMapItems;
		...
		public override void Load()
		{
			...
			var config = DataTableManager.LoadTable<MainGrinding150Cfg>(dataPath);
			dataItems = config.Data;

			idMapItems = new Dictionary<int, MainGrinding150Cfg>();
		...
		public override async UniTask LoadAsync()
		{
			...
			var config = await DataTableManager.LoadTableAsync<MainGrinding150Cfg>(dataPath);
			dataItems = config.Data;
		...
		public MainGrinding150Cfg GetDataById(int id)
		{
			Load();
