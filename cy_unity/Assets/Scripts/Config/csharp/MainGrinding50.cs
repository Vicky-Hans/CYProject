...
namespace DH.Config 
{
	...
	[DHDataTableObject]
	[MessagePackObject]
	public partial class MainGrinding50Cfg
	{
		[Key(0)]
		...
		public MainGrinding50Cfg()
		{
		}

		[SerializationConstructor]
		public MainGrinding50Cfg(int Id, int NextId, int CustomId, int NowWave, int Time, int GringTime, int Incident, int HpCoefficient, int AtkCoefficient, List<Grinding> Summon)
		{
			this.Id = Id;
			this.NextId = NextId;
	...
	public partial class MainGrinding50CfgCollection : CfgCollectionBase<MainGrinding50Cfg>
	{
		private const string dataPath = "MainGrinding50";
		private Dictionary<int, MainGrinding50Cfg> idMapItems;
		...
		public override void Load()
		{
			...
			var config = DataTableManager.LoadTable<MainGrinding50Cfg>(dataPath);
			dataItems = config.Data;

			idMapItems = new Dictionary<int, MainGrinding50Cfg>();
		...
		public override async UniTask LoadAsync()
		{
			...
			var config = await DataTableManager.LoadTableAsync<MainGrinding50Cfg>(dataPath);
			dataItems = config.Data;
		...
		public MainGrinding50Cfg GetDataById(int id)
		{
			Load();
