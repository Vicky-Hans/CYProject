...
namespace Pathfinding.DHRVO
{
	...
	public class RVOSimulator : MonoBehaviour
	{
		...
		/// </summary>
		[Tooltip(
			"Desired FPS for rvo simulation. It is usually not necessary to run a crowd simulation at a very high fps.\n" +
		...
		Pathfinding.DHRVO.Simulator simulator;
		...
		protected void Awake()
		{
			...
			{
				int threadCount = 2;
				simulator = new Pathfinding.DHRVO.Simulator(threadCount, doubleBuffering, movementPlane);
			}
		}
