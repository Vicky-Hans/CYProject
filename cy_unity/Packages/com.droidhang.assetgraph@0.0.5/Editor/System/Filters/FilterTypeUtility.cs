...
namespace UnityEngine.AssetGraph {
	...
	public static class FilterTypeUtility {
        ...
        private static readonly Dictionary<string, Type> s_defaultAssetFilterGUITypeMap = new Dictionary<string, Type> {
            ...
            //DHGames Start-----------------------
            //{"Timeline", typeof(UnityEngine.Timeline.TimelineAsset)},
            {"ShaderVariantCollection", typeof(UnityEngine.ShaderVariantCollection)},
            // {"LightingData", typeof(UnityEditor.LightingDataAsset)},
            // {"TerrainLayer", typeof(UnityEngine.TerrainLayer)},
            // {"VolumeProfile", typeof(UnityEngine.Rendering.VolumeProfile)},
            {"TMP_FontAsset", typeof(TMPro.TMP_FontAsset)},
            //DHGames End-----------------------
        };
