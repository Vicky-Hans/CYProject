    ...
    public static class PathUtility
    {
        ...
        public static void EnsureExistFileDirectory(string file)
        {
            try
            {
                ...
                {
                    Debug.Log($"[PathUtility]EnsureExistFileDirectory:{file} dirname is null");
                    return;
                }
            ...
            {
                Debug.Log($"[PathUtility]EnsureExistFileDirectory:{file}");
        ...
        public static void EnsureNotExistFileDirectory(string file)
        {
            ...
            if (string.IsNullOrEmpty(dirName))
            {
                Debug.Log($"[PathUtility]EnsureNotExistFileDirectory:{file} dirname is null");
                return;
            }
