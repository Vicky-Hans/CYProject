...
namespace DHFramework
{
    ...
    public static class GameFrameworkEntry
    {
        ...
        public static void RemoveModule(GameFrameworkModule module)
        {
            if (module == null)
            {
                return;
        ...
        private static GameFrameworkModule CreateModule(Type moduleType)
        {
            ...
            if (module == null)
            {
                throw new GameFrameworkException(DHUtility.Format("Can not create module '{0}'.", moduleType.FullName));
            }
